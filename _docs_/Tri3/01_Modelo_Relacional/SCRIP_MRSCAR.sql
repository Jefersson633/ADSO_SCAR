...
-- -----------------------------------------------------
-- Schema db_proyecto_tecnologo
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema db_proyecto_tecnologo
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `db_proyecto_tecnologo` DEFAULT CHARACTER SET utf8 ;
USE `db_proyecto_tecnologo` ;

-- -----------------------------------------------------
-- Table `db_proyecto_tecnologo`.`ROLES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_proyecto_tecnologo`.`ROLES` (
...
-- -----------------------------------------------------
-- Table `db_proyecto_tecnologo`.`CATEGORIAS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_proyecto_tecnologo`.`CATEGORIAS` (
...
-- -----------------------------------------------------
-- Table `db_proyecto_tecnologo`.`PRODUCTOS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_proyecto_tecnologo`.`PRODUCTOS` (
  ...
  CONSTRAINT `fk_PRODUCTOS_CATEGORIAS1`
    ...
    REFERENCES `db_proyecto_tecnologo`.`CATEGORIAS` (`categoria_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_proyecto_tecnologo`.`REPARTIDORES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_proyecto_tecnologo`.`REPARTIDORES` (
...
-- -----------------------------------------------------
-- Table `db_proyecto_tecnologo`.`USUARIOS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_proyecto_tecnologo`.`USUARIOS` (
  ...
  CONSTRAINT `fk_USUARIOS_ROLES`
    ...
    REFERENCES `db_proyecto_tecnologo`.`ROLES` (`rol_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_proyecto_tecnologo`.`VENTAS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_proyecto_tecnologo`.`VENTAS` (
  ...
  CONSTRAINT `fk_VENTAS_USUARIOS1`
    ...
    REFERENCES `db_proyecto_tecnologo`.`USUARIOS` (`usuario_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_proyecto_tecnologo`.`DETALLE DE VENTAS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_proyecto_tecnologo`.`DETALLE DE VENTAS` (
  ...
  CONSTRAINT `fk_DETALLE DE VENTAS_VENTAS1`
    ...
    REFERENCES `db_proyecto_tecnologo`.`VENTAS` (`venta_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DETALLE DE VENTAS_PRODUCTOS1`
    FOREIGN KEY (`PRODUCTOS_producto_id`)
    REFERENCES `db_proyecto_tecnologo`.`PRODUCTOS` (`producto_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_proyecto_tecnologo`.`DOMICILIOS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_proyecto_tecnologo`.`DOMICILIOS` (
  ...
  CONSTRAINT `fk_DOMICILIOS_REPARTIDORES1`
    FOREIGN KEY (`REPARTIDORES_editorial_id`)
    REFERENCES `db_proyecto_tecnologo`.`REPARTIDORES` (`repartidor_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
